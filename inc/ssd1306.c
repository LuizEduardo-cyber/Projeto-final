...
void display_text(ssd1306_t *ssd, const char *text) {
  ssd1306_fill(ssd, 0); // Limpa a tela (preenche com preto)
  ssd1306_draw_string(ssd, text, 45, 30); // Escreve o texto na posição (5,5)
  ssd1306_send_data(ssd); // Atualiza o display com as mudanças
}
